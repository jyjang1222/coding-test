...
# 계산기
# [1] 수식 변경 ==> data 의 문자열을 한글자씩 아래 조건을 실행한다.
# 1) 숫자면 calc 에 저장
# 2) 연산자면 ( , ) , +- , */ 에따라 달라진다.
...
# -----------------------------------------------------------
# [2] 수식 계산  ==> data 의 문자열을 한글자씩 아래 조건을 실행한다.
# 1) 숫자면 stack 에 저장
# 2) 연산자를 만나면 stack 에 있는 값을 2개 꺼내서 연산자와 연산후 다시 stack 저장 (예) 1 2 + ==> 3
# 3) 마지막 값 출력
